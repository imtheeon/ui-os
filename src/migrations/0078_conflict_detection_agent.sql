-- ============================================================================
-- U-I-OS Migration 0078 — Conflict Detection Agent
-- ============================================================================
-- Adds role 'conflict_detection_agent', action kind 'detect_conflicts', and
-- the conflict_detection_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0077.
-- ============================================================================

-- 1. agent_runs.role += 'conflict_detection_agent'
...
-- 2. proposed_actions.kind += 'detect_conflicts'
...
-- 4. conflict_detection_runs — executor target (one row per approved detect_conflicts action)
...
create index idx_conflict_detection_runs_org_id on conflict_detection_runs(org_id);
create index idx_conflict_detection_runs_payload_id on conflict_detection_runs(payload_id);

alter table conflict_detection_runs enable row level security;
create policy tenant_isolation_conflict_detection_runs on conflict_detection_runs
