-- ============================================================================
-- U-I-OS Migration 0079 — Action Priority Agent
-- ============================================================================
-- Adds role 'action_priority_agent', action kind 'prioritize_actions', and
-- the action_priority_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0078.
-- ============================================================================

-- 1. agent_runs.role += 'action_priority_agent'
...
-- 2. proposed_actions.kind += 'prioritize_actions'
...
-- 4. action_priority_runs — executor target (one row per approved prioritize_actions action)
create table action_priority_runs (
...
create index idx_action_priority_runs_org_id on action_priority_runs(org_id);
create index idx_action_priority_runs_payload_id on action_priority_runs(payload_id);

alter table action_priority_runs enable row level security;
create policy tenant_isolation_action_priority_runs on action_priority_runs
