-- ============================================================================
-- U-I-OS Migration 0070 — Concentration Risk Agent
-- ============================================================================
-- Adds role 'concentration_risk_agent', action kind 'analyze_concentration_risk',
-- and the concentration_risk_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0069.
-- ============================================================================

-- 1. agent_runs.role += 'concentration_risk_agent'
...
-- 2. proposed_actions.kind += 'analyze_concentration_risk'
...
-- 4. concentration_risk_runs — executor target (one row per approved analyze_concentration_risk action)
create table concentration_risk_runs (
...
create index idx_concentration_risk_runs_org_id on concentration_risk_runs(org_id);
create index idx_concentration_risk_runs_payload_id on concentration_risk_runs(payload_id);

alter table concentration_risk_runs enable row level security;
create policy tenant_isolation_concentration_risk_runs on concentration_risk_runs
