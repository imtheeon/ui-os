-- ============================================================================
-- U-I-OS Migration 0099 — Asset Register Agent
-- ============================================================================
-- Adds role 'asset_register_agent', action kind 'analyze_asset_register', and
-- the asset_register_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0098.
-- ============================================================================

-- 1. agent_runs.role += 'asset_register_agent'
...
-- 2. proposed_actions.kind += 'analyze_asset_register'
...
-- 4. asset_register_runs — executor target (one row per approved analyze_asset_register action)
create table asset_register_runs (
...
create index idx_asset_register_runs_org_id on asset_register_runs(org_id);
create index idx_asset_register_runs_payload_id on asset_register_runs(payload_id);

alter table asset_register_runs enable row level security;
create policy tenant_isolation_asset_register_runs on asset_register_runs
