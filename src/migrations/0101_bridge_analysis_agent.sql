-- ============================================================================
-- U-I-OS Migration 0101 — Bridge Analysis Agent
-- ============================================================================
-- Adds role 'bridge_analysis_agent', action kind 'build_bridge_analysis', and
-- the bridge_analysis_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0100.
-- ============================================================================

-- 1. agent_runs.role += 'bridge_analysis_agent'
...
-- 4. bridge_analysis_runs — executor target (one row per approved build_bridge_analysis action)
create table bridge_analysis_runs (
...
create index idx_bridge_analysis_runs_org_id on bridge_analysis_runs(org_id);
create index idx_bridge_analysis_runs_payload_id on bridge_analysis_runs(payload_id);

alter table bridge_analysis_runs enable row level security;
create policy tenant_isolation_bridge_analysis_runs on bridge_analysis_runs
