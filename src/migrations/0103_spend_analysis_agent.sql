-- ============================================================================
-- U-I-OS Migration 0103 — Spend Analysis Agent
-- ============================================================================
-- Adds role 'spend_analysis_agent', action kind 'analyze_spend', and the
-- spend_analysis_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0102.
-- ============================================================================

-- 1. agent_runs.role += 'spend_analysis_agent'
...
-- 2. proposed_actions.kind += 'analyze_spend'
...
-- 3. agent_accuracy.agent_role += 'spend_analysis_agent'
...
-- 4. spend_analysis_runs — executor target (one row per approved analyze_spend action)
create table spend_analysis_runs (
...
create index idx_spend_analysis_runs_org_id on spend_analysis_runs(org_id);
create index idx_spend_analysis_runs_payload_id on spend_analysis_runs(payload_id);

alter table spend_analysis_runs enable row level security;
create policy tenant_isolation_spend_analysis_runs on spend_analysis_runs
