-- ============================================================================
-- U-I-OS Migration 0086 — Subscription Tracker
-- ============================================================================
-- Adds role 'subscription_tracker', action kind 'track_subscriptions', and the
-- subscription_tracker_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0085.
-- ============================================================================

-- 1. agent_runs.role += 'subscription_tracker'
...
-- 2. proposed_actions.kind += 'track_subscriptions'
...
-- 3. agent_accuracy.agent_role += 'subscription_tracker'
...
-- 4. subscription_tracker_runs — executor target (one row per approved track_subscriptions action)
create table subscription_tracker_runs (
...
create index idx_subscription_tracker_runs_org_id on subscription_tracker_runs(org_id);
create index idx_subscription_tracker_runs_payload_id on subscription_tracker_runs(payload_id);

alter table subscription_tracker_runs enable row level security;
create policy tenant_isolation_subscription_tracker_runs on subscription_tracker_runs
