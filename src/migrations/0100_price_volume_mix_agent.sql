-- ============================================================================
-- U-I-OS Migration 0100 — Price Volume Mix Agent
-- ============================================================================
-- Adds role 'price_volume_mix_agent', action kind 'analyze_price_volume_mix',
-- and the price_volume_mix_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0099.
-- ============================================================================

-- 1. agent_runs.role += 'price_volume_mix_agent'
...
-- 2. proposed_actions.kind += 'analyze_price_volume_mix'
...
-- 4. price_volume_mix_runs — executor target (one row per approved analyze_price_volume_mix action)
create table price_volume_mix_runs (
...
create index idx_price_volume_mix_runs_org_id on price_volume_mix_runs(org_id);
create index idx_price_volume_mix_runs_payload_id on price_volume_mix_runs(payload_id);

alter table price_volume_mix_runs enable row level security;
create policy tenant_isolation_price_volume_mix_runs on price_volume_mix_runs
