-- ============================================================================
-- U-I-OS Migration 0067 — Contract Analysis Agent
-- ============================================================================
-- Adds role 'contract_analysis_agent', action kind 'analyze_contracts', and
-- the contract_analysis_runs record table (executor target for approved
-- analyses). Runs on BOTH the financial and non-financial routes.
-- Run once against the same DB as 0066.
-- ============================================================================

-- 1. agent_runs.role += 'contract_analysis_agent'
...
-- 2. proposed_actions.kind += 'analyze_contracts'
...
-- 3. agent_accuracy.agent_role += 'contract_analysis_agent'
...
-- 4. contract_analysis_runs — executor target (one row per approved analyze_contracts action)
...
create index idx_contract_analysis_runs_org_id on contract_analysis_runs(org_id);
create index idx_contract_analysis_runs_payload_id on contract_analysis_runs(payload_id);

alter table contract_analysis_runs enable row level security;
create policy tenant_isolation_contract_analysis_runs on contract_analysis_runs
