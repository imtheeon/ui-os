-- ============================================================================
-- U-I-OS Migration 0084 — Transaction Classifier
-- ============================================================================
-- Adds role 'transaction_classifier', action kind 'classify_transactions', and
-- the transaction_classifier_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0083.
-- ============================================================================

-- 1. agent_runs.role += 'transaction_classifier'
...
-- 2. proposed_actions.kind += 'classify_transactions'
...
-- 4. transaction_classifier_runs — executor target (one row per approved classify_transactions action)
create table transaction_classifier_runs (
...
create index idx_transaction_classifier_runs_org_id on transaction_classifier_runs(org_id);
create index idx_transaction_classifier_runs_payload_id on transaction_classifier_runs(payload_id);

alter table transaction_classifier_runs enable row level security;
create policy tenant_isolation_transaction_classifier_runs on transaction_classifier_runs
