-- ============================================================================
-- U-I-OS Migration 0026 — Report Generation agent
-- ============================================================================
-- Adds role 'report_generator', action kind 'generate_report', and the
-- generated_reports record table (executor target for approved reports).
-- Run once against the same DB as 0025.
-- ============================================================================

-- 1. agent_runs.role += 'report_generator'
...
-- 2. proposed_actions.kind += 'generate_report'
...
-- 4. generated_reports — executor target (one row per approved generate_report action)
...
create index idx_generated_reports_org_id on generated_reports(org_id);
create index idx_generated_reports_payload_id on generated_reports(payload_id);
