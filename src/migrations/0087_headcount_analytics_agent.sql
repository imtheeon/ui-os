-- ============================================================================
-- U-I-OS Migration 0087 — Headcount Analytics Agent
-- ============================================================================
-- Adds role 'headcount_analytics_agent', action kind
-- 'analyze_headcount_analytics' (distinct from a reserved 'analyze_headcount'
-- kind), and the headcount_analytics_runs record table (executor target for
-- approved analyses). Run once against the same DB as 0086.
-- ============================================================================

-- 1. agent_runs.role += 'headcount_analytics_agent'
...
-- 2. proposed_actions.kind += 'analyze_headcount_analytics'
...
-- 4. headcount_analytics_runs — executor target (one row per approved analyze_headcount_analytics action)
create table headcount_analytics_runs (
...
create index idx_headcount_analytics_runs_org_id on headcount_analytics_runs(org_id);
create index idx_headcount_analytics_runs_payload_id on headcount_analytics_runs(payload_id);

alter table headcount_analytics_runs enable row level security;
create policy tenant_isolation_headcount_analytics_runs on headcount_analytics_runs
