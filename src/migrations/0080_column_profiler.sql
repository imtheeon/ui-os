-- ============================================================================
-- U-I-OS Migration 0080 — Column Profiler
-- ============================================================================
-- Adds role 'column_profiler', action kind 'profile_columns', and the
-- column_profiler_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0079.
-- ============================================================================

-- 1. agent_runs.role += 'column_profiler'
...
-- 2. proposed_actions.kind += 'profile_columns'
...
-- 4. column_profiler_runs — executor target (one row per approved profile_columns action)
create table column_profiler_runs (
...
create index idx_column_profiler_runs_org_id on column_profiler_runs(org_id);
create index idx_column_profiler_runs_payload_id on column_profiler_runs(payload_id);

alter table column_profiler_runs enable row level security;
create policy tenant_isolation_column_profiler_runs on column_profiler_runs
