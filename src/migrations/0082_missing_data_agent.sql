-- ============================================================================
-- U-I-OS Migration 0082 — Missing Data Agent
-- ============================================================================
-- Adds role 'missing_data_agent', action kind 'analyze_missing_data', and the
-- missing_data_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0081.
-- ============================================================================

-- 1. agent_runs.role += 'missing_data_agent'
...
-- 2. proposed_actions.kind += 'analyze_missing_data'
...
-- 3. agent_accuracy.agent_role += 'missing_data_agent'
...
-- 4. missing_data_runs — executor target (one row per approved analyze_missing_data action)
create table missing_data_runs (
...
create index idx_missing_data_runs_org_id on missing_data_runs(org_id);
create index idx_missing_data_runs_payload_id on missing_data_runs(payload_id);

alter table missing_data_runs enable row level security;
create policy tenant_isolation_missing_data_runs on missing_data_runs
