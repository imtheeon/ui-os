-- ============================================================================
-- U-I-OS Migration 0073 — Covenant Tracking Agent
-- ============================================================================
-- Adds role 'covenant_tracking_agent', action kind 'track_covenants', and the
-- covenant_tracking_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0072.
-- ============================================================================

-- 1. agent_runs.role += 'covenant_tracking_agent'
...
-- 2. proposed_actions.kind += 'track_covenants'
...
-- 3. agent_accuracy.agent_role += 'covenant_tracking_agent'
...
-- 4. covenant_tracking_runs — executor target (one row per approved track_covenants action)
create table covenant_tracking_runs (
...
create index idx_covenant_tracking_runs_org_id on covenant_tracking_runs(org_id);
create index idx_covenant_tracking_runs_payload_id on covenant_tracking_runs(payload_id);

alter table covenant_tracking_runs enable row level security;
create policy tenant_isolation_covenant_tracking_runs on covenant_tracking_runs
