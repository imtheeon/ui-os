-- ============================================================================
-- U-I-OS Migration 0091 — Growth Rate Agent
-- ============================================================================
-- Adds role 'growth_rate_agent', action kind 'calculate_growth_rates', and the
-- growth_rate_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0090.
-- ============================================================================

-- 1. agent_runs.role += 'growth_rate_agent'
...
-- 2. proposed_actions.kind += 'calculate_growth_rates'
...
-- 4. growth_rate_runs — executor target (one row per approved calculate_growth_rates action)
create table growth_rate_runs (
...
create index idx_growth_rate_runs_org_id on growth_rate_runs(org_id);
create index idx_growth_rate_runs_payload_id on growth_rate_runs(payload_id);

alter table growth_rate_runs enable row level security;
create policy tenant_isolation_growth_rate_runs on growth_rate_runs
