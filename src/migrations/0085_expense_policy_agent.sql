-- ============================================================================
-- U-I-OS Migration 0085 — Expense Policy Agent
-- ============================================================================
-- Adds role 'expense_policy_agent', action kind 'check_expense_policy', and
-- the expense_policy_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0084.
-- ============================================================================

-- 1. agent_runs.role += 'expense_policy_agent'
...
-- 2. proposed_actions.kind += 'check_expense_policy'
...
-- 3. agent_accuracy.agent_role += 'expense_policy_agent'
...
-- 4. expense_policy_runs — executor target (one row per approved check_expense_policy action)
create table expense_policy_runs (
...
create index idx_expense_policy_runs_org_id on expense_policy_runs(org_id);
create index idx_expense_policy_runs_payload_id on expense_policy_runs(payload_id);

alter table expense_policy_runs enable row level security;
create policy tenant_isolation_expense_policy_runs on expense_policy_runs
