-- ============================================================================
-- U-I-OS Migration 0077 — Insight Synthesis Agent
-- ============================================================================
-- Adds role 'insight_synthesis_agent', action kind 'synthesize_insights', and
-- the insight_synthesis_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0076.
-- ============================================================================

-- 1. agent_runs.role += 'insight_synthesis_agent'
...
-- 2. proposed_actions.kind += 'synthesize_insights'
...
-- 4. insight_synthesis_runs — executor target (one row per approved synthesize_insights action)
create table insight_synthesis_runs (
...
create index idx_insight_synthesis_runs_org_id on insight_synthesis_runs(org_id);
create index idx_insight_synthesis_runs_payload_id on insight_synthesis_runs(payload_id);

alter table insight_synthesis_runs enable row level security;
create policy tenant_isolation_insight_synthesis_runs on insight_synthesis_runs
