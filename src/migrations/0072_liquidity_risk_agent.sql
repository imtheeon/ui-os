-- ============================================================================
-- U-I-OS Migration 0072 — Liquidity Risk Agent
-- ============================================================================
-- Adds role 'liquidity_risk_agent', action kind 'analyze_liquidity_risk', and
-- the liquidity_risk_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0071.
-- ============================================================================

-- 1. agent_runs.role += 'liquidity_risk_agent'
...
-- 2. proposed_actions.kind += 'analyze_liquidity_risk'
...
-- 3. agent_accuracy.agent_role += 'liquidity_risk_agent'
...
-- 4. liquidity_risk_runs — executor target (one row per approved analyze_liquidity_risk action)
create table liquidity_risk_runs (
...
create index idx_liquidity_risk_runs_org_id on liquidity_risk_runs(org_id);
create index idx_liquidity_risk_runs_payload_id on liquidity_risk_runs(payload_id);

alter table liquidity_risk_runs enable row level security;
create policy tenant_isolation_liquidity_risk_runs on liquidity_risk_runs
