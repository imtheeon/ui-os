-- ============================================================================
-- U-I-OS Migration 0059 — Working Capital Agent
-- ============================================================================
-- Adds role 'working_capital_agent', action kind 'analyze_working_capital', and
-- the working_capital_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0058.
-- ============================================================================

-- 1. agent_runs.role += 'working_capital_agent'
...
-- 2. proposed_actions.kind += 'analyze_working_capital'
...
-- 3. agent_accuracy.agent_role += 'working_capital_agent'
...
-- 4. working_capital_runs — executor target (one row per approved analyze_working_capital action)
create table working_capital_runs (
...
create index idx_working_capital_runs_org_id on working_capital_runs(org_id);
create index idx_working_capital_runs_payload_id on working_capital_runs(payload_id);

alter table working_capital_runs enable row level security;
create policy tenant_isolation_working_capital_runs on working_capital_runs
