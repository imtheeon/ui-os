-- ============================================================================
-- U-I-OS Migration 0081 — Data Dictionary Agent
-- ============================================================================
-- Adds role 'data_dictionary_agent', action kind 'build_data_dictionary', and
-- the data_dictionary_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0080.
-- ============================================================================

-- 1. agent_runs.role += 'data_dictionary_agent'
...
-- 2. proposed_actions.kind += 'build_data_dictionary'
...
-- 3. agent_accuracy.agent_role += 'data_dictionary_agent'
...
-- 4. data_dictionary_runs — executor target (one row per approved build_data_dictionary action)
create table data_dictionary_runs (
...
create index idx_data_dictionary_runs_org_id on data_dictionary_runs(org_id);
create index idx_data_dictionary_runs_payload_id on data_dictionary_runs(payload_id);

alter table data_dictionary_runs enable row level security;
create policy tenant_isolation_data_dictionary_runs on data_dictionary_runs
