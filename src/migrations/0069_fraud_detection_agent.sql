-- ============================================================================
-- U-I-OS Migration 0069 — Fraud Detection Agent
-- ============================================================================
-- Adds role 'fraud_detection_agent', action kind 'detect_fraud_signals', and
-- the fraud_detection_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0068.
-- ============================================================================

-- 1. agent_runs.role += 'fraud_detection_agent'
...
-- 2. proposed_actions.kind += 'detect_fraud_signals'
...
-- 4. fraud_detection_runs — executor target (one row per approved detect_fraud_signals action)
create table fraud_detection_runs (
...
create index idx_fraud_detection_runs_org_id on fraud_detection_runs(org_id);
create index idx_fraud_detection_runs_payload_id on fraud_detection_runs(payload_id);

alter table fraud_detection_runs enable row level security;
create policy tenant_isolation_fraud_detection_runs on fraud_detection_runs
