-- ============================================================================
-- U-I-OS Migration 0098 — Lease Analysis Agent
-- ============================================================================
-- Adds role 'lease_analysis_agent', action kind 'analyze_leases', and the
-- lease_analysis_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0097.
-- ============================================================================

-- 1. agent_runs.role += 'lease_analysis_agent'
...
-- 2. proposed_actions.kind += 'analyze_leases'
...
-- 4. lease_analysis_runs — executor target (one row per approved analyze_leases action)
create table lease_analysis_runs (
...
create index idx_lease_analysis_runs_org_id on lease_analysis_runs(org_id);
create index idx_lease_analysis_runs_payload_id on lease_analysis_runs(payload_id);

alter table lease_analysis_runs enable row level security;
create policy tenant_isolation_lease_analysis_runs on lease_analysis_runs
