-- ============================================================================
-- U-I-OS Migration 0090 — Overtime Analysis Agent
-- ============================================================================
-- Adds role 'overtime_analysis_agent', action kind 'analyze_overtime', and the
-- overtime_analysis_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0089.
-- ============================================================================

-- 1. agent_runs.role += 'overtime_analysis_agent'
...
-- 2. proposed_actions.kind += 'analyze_overtime'
...
-- 4. overtime_analysis_runs — executor target (one row per approved analyze_overtime action)
create table overtime_analysis_runs (
...
create index idx_overtime_analysis_runs_org_id on overtime_analysis_runs(org_id);
create index idx_overtime_analysis_runs_payload_id on overtime_analysis_runs(payload_id);

alter table overtime_analysis_runs enable row level security;
create policy tenant_isolation_overtime_analysis_runs on overtime_analysis_runs
