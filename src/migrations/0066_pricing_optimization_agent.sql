-- ============================================================================
-- U-I-OS Migration 0066 — Pricing Optimization Agent
-- ============================================================================
-- Adds role 'pricing_optimization_agent', action kind 'analyze_pricing', and
-- the pricing_optimization_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0065.
-- ============================================================================

-- 1. agent_runs.role += 'pricing_optimization_agent'
...
-- 2. proposed_actions.kind += 'analyze_pricing'
...
-- 4. pricing_optimization_runs — executor target (one row per approved analyze_pricing action)
...
create index idx_pricing_optimization_runs_org_id on pricing_optimization_runs(org_id);
create index idx_pricing_optimization_runs_payload_id on pricing_optimization_runs(payload_id);

alter table pricing_optimization_runs enable row level security;
create policy tenant_isolation_pricing_optimization_runs on pricing_optimization_runs
