-- ============================================================================
-- U-I-OS Migration 0029 — Vendor Risk agent
-- ============================================================================
-- Adds role 'vendor_risk', action kind 'assess_vendor_risk', and the
-- vendor_risk_assessments record table (executor target for approved
-- assessments).
-- Run once against the same DB as 0028.
-- ============================================================================

-- 1. agent_runs.role += 'vendor_risk'
...
-- 2. proposed_actions.kind += 'assess_vendor_risk'
...
-- 4. vendor_risk_assessments — executor target (one row per approved assess_vendor_risk action)
...
create index idx_vendor_risk_assessments_org_id on vendor_risk_assessments(org_id);
create index idx_vendor_risk_assessments_payload_id on vendor_risk_assessments(payload_id);
