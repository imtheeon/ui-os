-- ============================================================================
-- U-I-OS Migration 0076 — KPI Extractor
-- ============================================================================
-- Adds role 'kpi_extractor', action kind 'extract_kpis', and the
-- kpi_extractor_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0075.
-- ============================================================================

-- 1. agent_runs.role += 'kpi_extractor'
...
-- 2. proposed_actions.kind += 'extract_kpis'
...
-- 3. agent_accuracy.agent_role += 'kpi_extractor'
...
-- 4. kpi_extractor_runs — executor target (one row per approved extract_kpis action)
create table kpi_extractor_runs (
...
create index idx_kpi_extractor_runs_org_id on kpi_extractor_runs(org_id);
create index idx_kpi_extractor_runs_payload_id on kpi_extractor_runs(payload_id);

alter table kpi_extractor_runs enable row level security;
create policy tenant_isolation_kpi_extractor_runs on kpi_extractor_runs
