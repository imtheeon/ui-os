-- ============================================================================
-- U-I-OS Migration 0065 — Sales Pipeline Agent
-- ============================================================================
-- Adds role 'sales_pipeline_agent', action kind 'analyze_sales_pipeline', and
-- the sales_pipeline_runs record table (executor target for approved
-- analyses). Run once against the same DB as 0064.
-- ============================================================================

-- 1. agent_runs.role += 'sales_pipeline_agent'
...
-- 2. proposed_actions.kind += 'analyze_sales_pipeline'
...
-- 3. agent_accuracy.agent_role += 'sales_pipeline_agent'
...
-- 4. sales_pipeline_runs — executor target (one row per approved analyze_sales_pipeline action)
create table sales_pipeline_runs (
...
create index idx_sales_pipeline_runs_org_id on sales_pipeline_runs(org_id);
create index idx_sales_pipeline_runs_payload_id on sales_pipeline_runs(payload_id);

alter table sales_pipeline_runs enable row level security;
create policy tenant_isolation_sales_pipeline_runs on sales_pipeline_runs
