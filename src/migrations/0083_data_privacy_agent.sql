-- ============================================================================
-- U-I-OS Migration 0083 — Data Privacy Agent
-- ============================================================================
-- Adds role 'data_privacy_agent', action kind 'assess_data_privacy', and the
-- data_privacy_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0082.
-- ============================================================================

-- 1. agent_runs.role += 'data_privacy_agent'
...
-- 2. proposed_actions.kind += 'assess_data_privacy'
...
-- 4. data_privacy_runs — executor target (one row per approved assess_data_privacy action)
create table data_privacy_runs (
...
create index idx_data_privacy_runs_org_id on data_privacy_runs(org_id);
create index idx_data_privacy_runs_payload_id on data_privacy_runs(payload_id);

alter table data_privacy_runs enable row level security;
create policy tenant_isolation_data_privacy_runs on data_privacy_runs
