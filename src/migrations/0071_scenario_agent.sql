-- ============================================================================
-- U-I-OS Migration 0071 — Scenario Agent
-- ============================================================================
-- Adds role 'scenario_agent', action kind 'model_scenarios', and the
-- scenario_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0070.
-- ============================================================================

-- 1. agent_runs.role += 'scenario_agent'
...
-- 2. proposed_actions.kind += 'model_scenarios'
...
-- 4. scenario_runs — executor target (one row per approved model_scenarios action)
...
create index idx_scenario_runs_payload_id on scenario_runs(payload_id);

alter table scenario_runs enable row level security;
create policy tenant_isolation_scenario_runs on scenario_runs
