-- ============================================================================
-- U-I-OS Migration 0110 — Investor Memo Agent
-- ============================================================================
-- Adds role 'investor_memo_agent', action kind 'draft_investor_memo', and the
-- investor_memo_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0109.
-- ============================================================================

-- 1. agent_runs.role += 'investor_memo_agent'
...
-- 2. proposed_actions.kind += 'draft_investor_memo'
...
-- 4. investor_memo_runs — executor target (one row per approved draft_investor_memo action)
create table investor_memo_runs (
...
create index idx_investor_memo_runs_org_id on investor_memo_runs(org_id);
create index idx_investor_memo_runs_payload_id on investor_memo_runs(payload_id);

alter table investor_memo_runs enable row level security;
create policy tenant_isolation_investor_memo_runs on investor_memo_runs
