-- ============================================================================
-- U-I-OS Migration 0102 — Run Rate Agent
-- ============================================================================
-- Adds role 'run_rate_agent', action kind 'calculate_run_rate', and the
-- run_rate_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0101.
-- ============================================================================

-- 1. agent_runs.role += 'run_rate_agent'
...
-- 3. agent_accuracy.agent_role += 'run_rate_agent'
...
-- 4. run_rate_runs — executor target (one row per approved calculate_run_rate action)
create table run_rate_runs (
...
create index idx_run_rate_runs_org_id on run_rate_runs(org_id);
create index idx_run_rate_runs_payload_id on run_rate_runs(payload_id);

alter table run_rate_runs enable row level security;
create policy tenant_isolation_run_rate_runs on run_rate_runs
