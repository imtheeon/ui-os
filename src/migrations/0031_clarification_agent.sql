-- ============================================================================
-- U-I-OS Migration 0031 — Clarification agent
-- ============================================================================
-- Adds role 'clarification_agent', action kind 'request_clarification', and
-- the clarification_requests record table (executor target for approved
-- requests).
-- Run once against the same DB as 0030.
-- ============================================================================

-- 1. agent_runs.role += 'clarification_agent'
...
-- 2. proposed_actions.kind += 'request_clarification'
...
-- 4. clarification_requests — executor target (one row per approved request_clarification action)
...
create index idx_clarification_requests_org_id on clarification_requests(org_id);
create index idx_clarification_requests_payload_id on clarification_requests(payload_id);

alter table clarification_requests enable row level security;
create policy tenant_isolation_clarification_requests on clarification_requests
