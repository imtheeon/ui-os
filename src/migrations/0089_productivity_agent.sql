-- ============================================================================
-- U-I-OS Migration 0089 — Productivity Agent
-- ============================================================================
-- Adds role 'productivity_agent', action kind 'analyze_productivity', and the
-- productivity_runs record table (executor target for approved analyses).
-- Run once against the same DB as 0088.
-- ============================================================================

-- 1. agent_runs.role += 'productivity_agent'
...
-- 2. proposed_actions.kind += 'analyze_productivity'
...
-- 4. productivity_runs — executor target (one row per approved analyze_productivity action)
create table productivity_runs (
...
create index idx_productivity_runs_org_id on productivity_runs(org_id);
create index idx_productivity_runs_payload_id on productivity_runs(payload_id);

alter table productivity_runs enable row level security;
create policy tenant_isolation_productivity_runs on productivity_runs
